...
<head>
    ...
    <style>
        ...
        .edit-profile-btn {
            ...
            width: 100%;
            padding: 10px;
            background-color: #ADD8E6; /* 紫色背景，与顶部一致 */
            color: white;
            text-align: center;
            border-radius: 5px;
            margin-top: 20px;
                    ...
                    series: [
                        {
                            ...
                            radius: '50%',
                            data: [
                                {value: <?php echo $gameStatus['land_type_1_count']; ?>, name: '公共服务'},
                                {value: <?php echo $gameStatus['land_type_2_count']; ?>, name: '居住用地'},
                                {value: <?php echo $gameStatus['land_type_3_count']; ?>, name: '公园绿地'},
                                {value: <?php echo $gameStatus['land_type_4_count']; ?>, name: '商业设施'}
                            ],
                            emphasis: {
                                itemStyle: {
                                    shadowBlur: 10,
                    ...
                    series: [
                        {
                            ...
                            data: [<?php echo $gameStatus['land_type_1_count'] * 6.8; ?>, <?php echo $gameStatus['land_type_2_count'] * 5.5; ?>, <?php echo $gameStatus['land_type_3_count'] * 4; ?>, <?php echo $gameStatus['land_type_4_count'] * 7.45; ?>]
                        },
                        {
                            name: '用户方案',
                            type: 'line',
                            ...
                            data: [<?php echo $gameStatus['land_type_1_count'] * 4.5; ?>, <?php echo $gameStatus['land_type_2_count'] * 2.5; ?>, <?php echo $gameStatus['land_type_3_count'] * 2; ?>, <?php echo $gameStatus['land_type_4_count'] * 3.75; ?>]
                        },
                        {
                            name: '最劣方案',
                            type: 'line',
                            ...
                            data: [<?php echo $gameStatus['land_type_1_count'] * 2.5; ?>, <?php echo $gameStatus['land_type_2_count'] * 0.5; ?>, <?php echo $gameStatus['land_type_3_count'] * 0.8; ?>, <?php echo $gameStatus['land_type_4_count'] * 0.75; ?>]
                        }
                    ]
                };
...
<div class="footer-nav">
    ...
    <!--    <a href="./game.php" id="gameBtn" target="_blank">-->
